 ...
 * Description: CS372 Assignment 1: Chat server for 2-way text communication with 
 * chatclient program. See README.txt for instructions on compilation and execution.
 * Code Sources: http://www.cs.rpi.edu/~moorthy/Courses/os98/Pgms/socket.html
